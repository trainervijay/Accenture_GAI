...
- determine the ticket's priority,
- which team it should be assigned to,
...
with agents_client:
    ...
    prompt = "Please assess how urgent this ticket is and how much effort it might take to resolve. The issue is: Users receive a 500 error when submitting the payment form."
